<?php
/**
 * TOP API: t33hglzv00.wdgj.purchase.list.get request
 * 
 * @author auto create
 * @since 1.0, 2018.10.24
 */
class WdgjPurchaseListGetRequest
{
	/** 
	...
	/** 
	 * 0 待审核 1 执行中(到货与未到货) 2 被取消 3 已完成 4 被终止
	 **/
	private $searchstatus;
	
	/** 
	 * 查询时间类型 0：登记时间 1：预计到货时间 2：订货时间（不填或者填写其他值默认登记时间）
	 **/
	private $timetype;
	...
	{
		return "t33hglzv00.wdgj.purchase.list.get";
	}
