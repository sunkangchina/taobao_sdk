<?php
/**
 * TOP API: hu3cgwt0tc.wdt.his.stockin.order.query.refund request
 * 
 * @author auto create
 * @since 1.0, 2021.11.16
 */
class WdtHisStockinOrderQueryRefundRequest
{
	/** 
	 * 结束时间
	 **/
	...
	{
		return "hu3cgwt0tc.wdt.his.stockin.order.query.refund";
	}
