<?php
/**
 * TOP API: hu3cgwt0tc.wdt.ext.stockout.prder.query.trade.xc request
 * 
 * @author auto create
 * @since 1.0, 2020.11.13
 */
class WdtExtStockoutPrderQueryTradeXcRequest
{
	/** 
	 * 结束时间
	 **/
	...
	{
		return "hu3cgwt0tc.wdt.ext.stockout.prder.query.trade.xc";
	}
