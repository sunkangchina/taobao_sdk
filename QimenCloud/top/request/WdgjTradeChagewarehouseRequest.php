<?php
/**
 * TOP API: t33hglzv00.wdgj.trade.chagewarehouse request
 * 
 * @author auto create
 * @since 1.0, 2023.05.26
 */
class WdgjTradeChagewarehouseRequest
{
	/** 
	 * 根据format传入不同类型
	 **/
	...
	{
		return "t33hglzv00.wdgj.trade.chagewarehouse";
	}
