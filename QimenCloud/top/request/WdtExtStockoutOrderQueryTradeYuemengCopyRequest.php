<?php
/**
 * TOP API: hu3cgwt0tc.wdt.ext.stockout.order.query.trade.yuemeng.copy request
 * 
 * @author auto create
 * @since 1.0, 2021.03.14
 */
class WdtExtStockoutOrderQueryTradeYuemengCopyRequest
{
	/** 
	 * app_rights
	 **/
	...
	{
		return "hu3cgwt0tc.wdt.ext.stockout.order.query.trade.yuemeng.copy";
	}
