<?php
/**
 * TOP API: hu3cgwt0tc.wdt.ext.stockout.order.query.trade request
 * 
 * @author auto create
 * @since 1.0, 2020.06.01
 */
class WdtExtStockoutOrderQueryTradeRequest
{
	/** 
	 * 结束时间
	 **/
	...
	{
		return "hu3cgwt0tc.wdt.ext.stockout.order.query.trade";
	}
