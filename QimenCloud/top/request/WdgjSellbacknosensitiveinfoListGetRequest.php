<?php
/**
 * TOP API: t33hglzv00.wdgj.sellbacknosensitiveinfo.list.get request
 * 
 * @author auto create
 * @since 1.0, 2019.12.24
 */
class WdgjSellbacknosensitiveinfoListGetRequest
{
	/** 
	...
	{
		return "t33hglzv00.wdgj.sellbacknosensitiveinfo.list.get";
	}
