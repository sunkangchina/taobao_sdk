<?php
/**
 * TOP API: t33hglzv00.wdgj.inventory.list.get request
 * 
 * @author auto create
 * @since 1.0, 2018.10.24
 */
class WdgjInventoryListGetRequest
{
	/** 
	...
	/** 
	 * 订单状态 0 待盘点 1 已盘点 2 被取消
	 **/
	private $searchstatus;
	
	/** 
	 * 不填或者填写其他值默认创建时间 0：创建时间 1：盘点时间
	 **/
	private $timetype;
	...
	{
		return "t33hglzv00.wdgj.inventory.list.get";
	}
