<?php
/**
 * TOP API: hu3cgwt0tc.wdt.ext.stockin.order.query.refund.oupai request
 * 
 * @author auto create
 * @since 1.0, 2020.07.13
 */
class WdtExtStockinOrderQueryRefundOupaiRequest
{
	/** 
	 * app_rights
	 **/
	...
	{
		return "hu3cgwt0tc.wdt.ext.stockin.order.query.refund.oupai";
	}
