<?php
/**
 * TOP API: tmall.servicecenter.workcard.query request
 * 
 * @author auto create
 * @since 1.0, 2023.07.21
 */
class TmallServicecenterWorkcardQueryRequest
{
	/** 
	 * 淘宝交易订单号。主订单或子订单均可
	 **/
	...
	public function setNeedWorkcardOperation($needWorkcardOperation)
	{
		$this->needWorkcardOperation = $needWorkcardOperation;
		$this->apiParas["need_workcard_operation"] = $needWorkcardOperation;
	}

	public function getNeedWorkcardOperation()
	{
		return $this->needWorkcardOperation;
	}
