<?php
/**
 * TOP API: tmall.servicecenter.workcard.desensitization.query request
 * 
 * @author auto create
 * @since 1.0, 2022.06.29
 */
class TmallServicecenterWorkcardDesensitizationQueryRequest
{
	/** 
	 * 淘宝交易订单号。主订单或子订单均可
	 **/
	...
	public function setRequestSourceType($requestSourceType)
	{
		$this->requestSourceType = $requestSourceType;
		$this->apiParas["request_source_type"] = $requestSourceType;
	}

	public function getRequestSourceType()
	{
