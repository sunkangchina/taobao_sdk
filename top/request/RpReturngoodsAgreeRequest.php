...
class RpReturngoodsAgreeRequest
{
	...
	public function setVirtualReturnGoods($virtualReturnGoods)
	{
		$this->virtualReturnGoods = $virtualReturnGoods;
		$this->apiParas["virtual_return_goods"] = $virtualReturnGoods;
	}

	public function getVirtualReturnGoods()
	{
